...
final class AdminDeleteCategoryController extends AbstractController
{
    use UserTrait;
    ...
    /**
     * @Route("/admin/gallery/categories/{categoryId}/delete", name="admin_gallery_category_delete", methods={"GET"})
    ...
    public function __invoke(Request $request, int $categoryId): Response
    {
        ...
        $this->commandBus->dispatch(new DeleteCategoryCommand(
            $category->getId(),
            $this->getUserId(),
            time()
        ));
