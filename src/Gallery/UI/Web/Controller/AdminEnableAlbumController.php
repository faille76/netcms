...
final class AdminEnableAlbumController extends AbstractController
{
    use UserTrait;
    ...
    /**
     * @Route("/admin/gallery/albums/{albumId}/enable", name="admin_gallery_album_enable", methods={"GET"})
    ...
    public function __invoke(Request $request, int $albumId): Response
    {
        ...
        $this->commandBus->dispatch(new UpdateEnableAlbumCommand(
            $album->getId(),
            !$album->isEnabled(),
            $this->getUserId(),
            time()
