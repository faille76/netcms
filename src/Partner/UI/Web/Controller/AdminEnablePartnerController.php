...
final class AdminEnablePartnerController extends AbstractController
{
    use UserTrait;
    ...
    /**
     * @Route("/admin/partners/{partnerId}/enable", name="admin_partner_enable", methods={"GET"})
    ...
    public function __invoke(Request $request, int $partnerId): Response
    {
        ...
        $this->commandBus->dispatch(new UpdateEnablePartnerCommand(
            $partner->getId(),
            !$partner->isEnabled(),
            $this->getUserId(),
            time()
